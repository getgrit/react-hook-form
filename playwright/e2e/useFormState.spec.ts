...
test.describe('useFormState', () => {
  test.skip('should subscribed to the form state without re-render the root', async ({ page }) => {
    ...
    await page.locator('input[name="lastName"]').clear().fill('luo');
...
*/
    ...
    await page.locator('input[name="min"]').clear().fill('11');
    await page.locator('input[name="max"]').clear().fill('19');
